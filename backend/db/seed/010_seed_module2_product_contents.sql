-- Real gap found while reasoning through a pricing proposal (2026-08-11): Module 2's
-- two lessons (added in 007/008, both now published) were never linked to any
-- product_contents row, so nobody who bought risk-register-template could actually
...
-- — see docs/pricing.md's "don't price ahead of real content" note).
