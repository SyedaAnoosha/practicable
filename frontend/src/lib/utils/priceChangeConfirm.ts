// Phase 8 (8B-7): "A confirmation step for a change over ±50% or to zero, naming both
// figures: `A$99.00 → A$9.90. Change the price?`" — fat-finger protection on the one
// field where a slip charges a real card the wrong amount.
...
// The exact sentence the DoD names, e.g. "A$99.00 → A$9.90. Change the price?"
