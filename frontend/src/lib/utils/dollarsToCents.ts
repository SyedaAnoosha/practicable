// Phase 8 (8B-6): the field takes dollars and stores cents, with the conversion in
// exactly one place. A price editor that is off by 100 is the most expensive typo
