...
// The ACCC's published position (tested in ACCC v Valve) is that "no refunds", "all
// sales final" or "store credit only" are THEMSELVES misleading conduct under the ACL,
// regardless of the product being digital. This page states the statutory guarantees as
// applying independently of anything below — a clause purporting to exclude them is void
// and risks being read as further misleading conduct.
  ...
  return (
    ...
    >
      <LegalSection heading="Your consumer guarantees come first">
        {/* The same sentence as /store's footer and the
