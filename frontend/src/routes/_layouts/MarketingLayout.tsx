...
export default function MarketingLayout() {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-background text-foreground">
      ...
      >
        {/* The gilt edge: a 2px navy-to-gold hairline along the very top of the
        ...
        <div className="mx-auto flex w-full max-w-6xl items-center justify-between gap-6 px-5 py-4 sm:px-8">
          <Link to="/" className="flex items-center gap-2.5 font-sans text-lg font-semibold tracking-tight">
      ...
      {menuOpen && (
        <div className="fixed inset-0 z-50 md:hidden">
          ...
          <aside className="absolute inset-y-0 right-0 flex w-80 flex-col bg-card shadow-xl">
